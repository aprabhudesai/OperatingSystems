...
class AddrSpace {
 ...
 private:
	...
	TranslationEntry *newPageTable;	// Used whenever a new stack has to be allocated
	...
	//unsigned int numOfStackPages; // Number of pages for stack in the virtual address space
