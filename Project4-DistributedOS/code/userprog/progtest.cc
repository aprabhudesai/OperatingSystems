...
PacketHeader outPktHdr4, inPktHdr4;		
MailHeader outMailHdr4, inMailHdr4;
...
void clientPinger()
{
	...
	while(1)
	{
		postOffice -> Receive(39, &inPktHdr4, &inMailHdr4, buffer4);
	}
}
...
StartProcess(char *filename)
{
	...
	if(testcase == 2)
	{
		Thread *pinger = new Thread("pinger");
	
		pinger -> Fork((VoidFunctionPtr)clientPinger,0);
	}
#endif
